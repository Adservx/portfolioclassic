...
className="plate p-6 sm:p-8 lg:p-10 max-w-sm mx-auto hover:shadow-[0_30px_60px_rgba(0, 0, 0,0.15)] transition-shadow duration-700 relative overflow-hidden"
style={{
...
style={{
background:
"linear-gradient(180deg, rgba(0, 0, 0,0.2) 0%, transparent 35%, transparent 60%, rgba(0, 0, 0,0.65) 100%)",
}}
/>
<div
className="absolute inset-0 pointer-events-none"
...
>
<div className="font-serif text-lg lg:text-2xl leading-snug max-w-xl">
...
viewport={{ once: true }}
transition={{ delay: 1 }}
className="mt-3 text-center font-serif text-xs sm:text-sm text-ink-soft px-4"
>
...
<rect x="-3" y="-28" width="2.5" height="34" rx="1.5" fill="#FAFAFA" opacity="0.06" />
<rect x="-5.5" y="6" width="11" height="2.5" rx="1" fill="#444444" opacity="0.7" />
<path d="M -5 8.5 L 5 8.5 L 3.5 15 L -3.5 15 Z" fill="currentColor" opacity="0.95" />
<line x1="-3.5" y1="10" x2="3.5" y2="10" stroke="#FFFFFF" strokeWidth="0.2" opacity="0.1" />
<line x1="-3.5" y1="11.5" x2="3.5" y2="11.5" stroke="#FFFFFF" strokeWidth="0.2" opacity="0.1" />
<line x1="-3.5" y1="13" x2="3.5" y2="13" stroke="#FFFFFF" strokeWidth="0.2" opacity="0.1" />
<path d="M -3.5 15 L 3.5 15 L 2.5 23 L 0 28 L -2.5 23 Z" fill="#333333" />
...
<ellipse cx="0" cy="-16" rx="6" ry="2" fill="#333333" />
...
<g key={i}>
<ellipse cx={d.cx} cy={73} rx="1.2" ry="1.2" fill="#000000" opacity="0">
...
<ellipse cx={d.cx} cy={73} rx="0.8" ry="0.4" fill="#000000" opacity="0">
...
<circle cx={d.cx} cy={179} r="0.8" fill="#000000" opacity="0">
...
<circle cx={d.cx} cy={179} r="0.6" fill="#000000" opacity="0">
...
<circle cx={d.cx} cy={179} r="0.5" fill="#000000" opacity="0">
...
<circle cx={d.cx} cy={179} r="0.4" fill="#000000" opacity="0">
...
<ellipse cx={d.cx} cy={179} rx="1" ry="0.3" fill="none" stroke="#000000" strokeWidth="0.6" opacity="0">
