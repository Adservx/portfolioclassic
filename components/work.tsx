      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          <div className="font-serif italic text-sm text-ink-soft">
            ...
            <Link href="/bookstore" className="underline decoration-oxblood/30 underline-offset-4 hover:text-oxblood transition-colors">
              Bookstore
            </Link>.
          </div>
    ...
    >
      ...
      <div className="col-span-3 sm:col-span-2 lg:col-span-1">
        <motion.div
          ...
          className="font-serif italic text-xl sm:text-2xl lg:text-3xl text-ink-soft leading-none"
        >
          {w.year}
        </motion.div>
      </div>
      ...
      <div className="col-span-6 sm:col-span-8 lg:col-span-5">
        <div className="flex items-baseline gap-2 sm:gap-3 flex-wrap">
          <h3 className="font-serif text-xl sm:text-2xl lg:text-3xl text-ink group-hover:text-oxblood transition-colors duration-500 link-underline inline-block cursor-pointer">
            {w.title}
          </h3>
          {w.featured && (
            <motion.span
        ...
        <p className="mt-2 font-serif italic text-[0.95rem] sm:text-[1.02rem] leading-relaxed text-ink-soft max-w-2xl">
          {w.excerpt}
        </p>
      </div>
      ...
      <div className="col-span-12 sm:col-span-12 lg:col-span-3 lg:text-right mt-3 sm:mt-2 lg:mt-0">
        ...
        <div className="mt-0.5 font-serif italic text-xs sm:text-sm text-ink-soft">
          {w.edition}
        </div>
      </div>
